                                    ...
                                    <div className='box-list-order'>
                                        <div className='content-top'>
                                            <div className='content-left'>
                                                ...
                                                <span className='label-name-shop'>UIT sport</span>
                                                <div className='view-shop'>
                                                    <i className="fas fa-store"></i>

                                                    <a style={{ color: 'black' }} href='/shop'>View shop</a>
                                                </div>
                                            </div>
                                            <div className='content-right'>
                                                {item.statusOrderData && item.statusOrderData.value} {item.isPaymentOnlien == 1 && ' | Paid.'}
                                            </div>
                                        </div>
                                                    ...
                                                    <div className='content-center'>
                                                        <div className='box-item-order'>
                                                            ...
                                                            <div className='box-des'>
                                                                ...
                                                                <span className='type'>Sort items: {item.productDetail.nameDetail} | {item.productDetailSize.sizeData.value}</span>
