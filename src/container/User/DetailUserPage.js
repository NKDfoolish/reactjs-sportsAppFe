...
function DetailUserPage(props) {
    ...
    let handleOnChangeImage = async (event) => {
        ...
        if (file.size > 31312281) {
            toast.error("The file size is less than 30MB.")
        }
        else {
                ...
                <div className="col-md-9 border-right">
                    <div className="p-3 py-5">
                        ...
                        <div className="row mt-2">
                            <div className="col-md-6"><label className="labels">Last name</label><input name="firstName" onChange={(event) => handleOnChange(event)} value={inputValues.firstName} type="text" className="form-control" /></div>
                            <div className="col-md-6"><label className="labels">First name</label><input name="lastName" onChange={(event) => handleOnChange(event)} value={inputValues.lastName} type="text" className="form-control" /></div>
                        </div>
                        <div className="row mt-3">
                            <div className="col-md-12"><label className="labels">Phone number</label><input name="phonenumber" onChange={(event) => handleOnChange(event)} type="text" className="form-control" value={inputValues.phonenumber} /></div>
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-6"><label className="labels">Day of birth</label> <DatePicker className="form-control" onChange={handleOnChangeDatePicker}
                                value={birthday}
