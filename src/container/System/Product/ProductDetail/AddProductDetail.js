...
const AddProductDetail = (props) => {
    ...
    let handleSaveProductDetail = async () => {
        ...
        if (res && res.errCode === 0) {
            toast.success("Create new product type successfully!")
            setInputValues({
                ...inputValues,
    ...
    return (
        <div className="container-fluid px-4">
            <h1 className="mt-4">Manage product details</h1>
                ...
                <div className="card-body">
                    <form>
                        <div className="form-row">
                            ...
                            <div className="form-group col-md-4">
                                <label htmlFor="inputPassword4">Length</label>
                        ...
                        <div className="form-group col-md-4">
                                <label htmlFor="inputPassword4">Dimensions</label>
