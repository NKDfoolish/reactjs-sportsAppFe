...
const ManageProductImage = () => {
    ...
    let sendDataFromModalSize = async (data) => {
        if (data.isActionUpdate === false) {
            ...
            if (response && response.errCode === 0) {
                ...
                toast.error("Fail to add dimension!")
            }
        } else {
            ...
            if (response && response.errCode === 0) {
                setproductSizeId('')
                toast.success("Updated dimension successfully!")
                setisOpenModalSize(false)
                await loadProductDetailSize()

            } else {
                toast.error("Fail to update dimension!")
            }
        }
    }
    ...
    let handleDeleteProductSize = async (productdetailsizeId) => {
        ...
        if (response && response.errCode === 0) {
            toast.success("Deleted dimension successfully !")
    ...
    return (
        <div className="container-fluid px-4">
            <h1 className="mt-4">Detail product information</h1>

            <div>
                <div className="card mb-4">
                    <div className="card-header">
                        <i className="fas fa-table me-1" />
                        List of detail product image
            ...
            <div>
                <div className="card mb-4">
                    <div className="card-header">
                        <i className="fas fa-table me-1" />
                        List of product detail dimension
