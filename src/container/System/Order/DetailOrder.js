...
function DetailOrder(props) {
    ...
    let handleSendProduct = async () => {
        ...
        if (res && res.errCode == 0) {
            toast.success("Shipping confirmation successful")
            loadDataOrder()
        }
    }
            ...
            <div className="wrap-order">
                            ...
                            <div className="box-shopcart-bottom">
                                <div className="content-left">
                                    ...
                                    <div className="wrap-note">
                                        <span>Message:</span>
                                        <input value={DataOrder.note} type="text" placeholder="Note to the Seller..." />
                                    </div>
                                </div>
                                ...
                                <div className="content-right">
                                    <div className="wrap-price">
                                        <span className="text-total">Total payment {DataOrder && DataOrder.orderDetail && DataOrder.orderDetail.length} product: </span>
                ...
                <div className="wrap-payment">
                    ...
                    <div className="content-bottom">
                        ...
                        <div className="wrap-bottom">
                            <div className="box-flex">
                                <div className="head">Total order amount</div>
                            ...
                            <div className="box-flex">
                                ...
                                {DataOrder && DataOrder.statusId == 'S4' &&
                                    <a onClick={() => handleSendProduct()} className="main_btn">Shipping</a>
                                }
