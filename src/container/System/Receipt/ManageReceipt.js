...
const ManageReceipt = () => {
    ...
    let handleOnClickExport =async () =>{
        ...
        if(res && res.errCode == 0){
            await CommonUtils.exportExcel(res.data,"List of inventory","ListReceipt")
        }
        ...
        <div className="container-fluid px-4">
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    ...
                    <button  style={{float:'right'}} onClick={() => handleOnClickExport()} className="btn btn-success mb-2" >Export to Excel <i class="fa-solid fa-file-excel"></i></button>
                    </div>
                    </div>
