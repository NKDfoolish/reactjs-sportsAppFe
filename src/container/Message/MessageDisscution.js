    ...
    return (
        ...
        <div className="ks-search">
          <div className="input-icon icon-right icon icon-lg icon-color-primary">
            <input onChange={(e) => handleOnchangeSearch(e)} value={textSearch} id="input-group-icon-text" type="text" className="form-control" placeholder="Find by name" />
                ...
                return(
                  ...
                  <a href="#">
                    ...
                    <div className="ks-body">
                      ...
                      <div className="ks-message">{item.messageData && item.messageData.length > 0 ? item.messageData[item.messageData.length-1].text :'No messages yet'}</div>
                    </div>
                  </a>
                </li>
                )
