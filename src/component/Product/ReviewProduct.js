...
function ReviewProduct(props) {
    ...
    let handleSaveComment = async () => {
        if (!inputValues.activeStar) toast.error("You haven't selected a star!")
        else if (!inputValues.content) toast.error("Content cannot be empty!")
        else {
                ...
                <div className="row total_rate">
                    <div className="col-6">
                        <div className="box_total">
                            ...
                            <h6>({inputValues.countStar.quantity} Number of reviews)</h6>
                        </div>
                    </div>
                    <div className="col-6">
                        <div className="rating_list">
                            <h3>{inputValues.countStar.quantity} Number of reviews</h3>
                            <ul className="list">
                                <li>
                                    <a href="#">5
                                        ...
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" />
                                        <i className="fa fa-star" /> Yes {inputValues.countStar.star5} Number of reviews</a>
                                </li>
                                <li>
                                    <a href="#">4
                                        <i className="fa fa-star" />
                                        ...
                                        <i className="fa fa-star" /> Yes {inputValues.countStar.star4} Number of reviews</a>
                                </li>
                                <li>
                                    <a href="#">3
                                        <i className="fa fa-star" />
                                        ...
                                        <i className="fa fa-star" /> Yes {inputValues.countStar.star3} Number of reviews</a>
                                </li>
                                <li>
                                    <a href="#">2
                                        <i className="fa fa-star" />

                                        <i className="fa fa-star" /> Yes {inputValues.countStar.star2} Number of reviews</a>
                                </li>
                                <li>
                                    <a href="#">1

                                        <i className="fa fa-star" /> Yes {inputValues.countStar.star1} Number of reviews</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div className="media">
                                            ...
                                            <div className="media-body">
                                                ...
                                                {inputValues.user && inputValues.user.roleId === "R1" &&
                                                    <a style={{ cursor: 'pointer' }} onClick={() => handleOpenModal(item.id)} className="reply_btn" >Feedback</a>
                                                }
                                                ...
                                                item.childComment.map((item, index) => {
                                                    return (
                                                        <div key={index} className="box-reply">
                                                            <span>Seller's feedback</span>
                                                            <p>{item.content}</p>
                                                            {inputValues.user && inputValues.user.roleId === "R1" &&
                                                                <button onClick={() => handleDeleteReply(item.id)} className="btn-delete-reply" type="button">Remove</button>
                                                            }
                                                        </div>
                                                    )
                                                })
