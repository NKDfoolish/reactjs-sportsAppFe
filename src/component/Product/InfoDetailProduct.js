                                        ...
                                        return (
                                            ...
                                            <div onClick={() => openPreviewImage(item.image)} style={{ cursor: 'pointer' }} className="carousel-item active">
                                                <img className="d-block w-100"
                                                    src={item.image} alt="The image is corrupted" />
                                            </div>
                                        )
                                    } else {
                                        return (
            ...
            <div className="col-lg-5 offset-lg-1">
                <div className="s_product_text">
                    ...
                    <ul className="list">
                        ...
                        <li>
                            <a href="#">{quantity} Product available</a>
                        </li>
                    </ul>
                    <p>
                    ...
                    <div style={{ display: 'flex' }}>
                        ...
                        <div className="form-group">
                            <label style={{ fontSize: '14px', color: '#797979', fontFamily: '"Roboto",sans-serif', marginLeft: '16px' }} htmlFor="type">Product type</label>
